...
<header role="banner" itemscope itemtype="https://schema.org/WPHeader">
    <nav id="navbar" role="navigation" vocab="http://schema.org" typeof="SiteNavigationElement" itemscope itemtype="https://schema.org/SiteNavigationElement" class="navbar z-10 {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'bg-primary-950' : ''} {id.includes('article') ? 'bg-white' : ''} transition-all transition-300">
        <div class="max-w-screen flex justify-between pr-6 xl:pr-10 2xl:pr-20 pl-6 xl:pl-10 2xl:pl-20 py-4 xl:py-6 align-middle">
            <div class="navbar__menu flex flex-row gap-6 xl:gap-10 items-center z-45" id="menu">
                <a href="/" id="adshelp-logo" rel="index" itemprop="url" class="h-card">
                    {#if id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt')}
                        {#if isMenuOpen}
                            <img src={logo} alt="Logo of company Adshelp" itemprop="logo" itemscope itemtype="https://schema.org/ImageObject" />
                        {:else}
                            <img src={logoWhite} alt="Logo of company Adshelp" itemprop="logo" itemscope itemtype="https://schema.org/ImageObject" />
                        {/if}
                    {:else}
                        <img src={logo} alt="Logo of company Adshelp" itemprop="logo" itemscope itemtype="https://schema.org/ImageObject" />
                    {/if}
                      <!-- Hidden organization data -->
                      <span class="p-org u-org" style="display: none;" itemprop="name">AdsHelp</span>
                      <span style="display: none;" itemprop="description">Ekspert kampanii reklamowych Allegro Ads</span>
                </a>            
                <div class="hidden xl:flex {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-[#340B07]' : 'text-neutral-200'}">|</div>
                <ul class="flex flex-row gap-3 max-[852px]:hidden" itemscope 
                itemtype="https://schema.org/ItemList"
                role="menubar">
                    <meta itemprop="name" content="Main Menu" />
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="url" href="/#about" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'}  transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85" itemscope itemtype="https://schema.org/WebPage"><span itemprop="name">O mnie</span></a><meta itemprop="position" content="1"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="url" href="/#steps" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85" itemscope itemtype="https://schema.org/WebPage"><span itemprop="name">Dlaczego warto</span></a><meta itemprop="position" content="2"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="url" href="/#services" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85" itemscope itemtype="https://schema.org/WebPage"><span itemprop="name">Usługi</span></a><meta itemprop="position" content="3"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="url" href="/blog" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85" itemscope itemtype="https://schema.org/WebPage"><span itemprop="name">Blog</span></a><meta itemprop="position" content="4"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="url" href="/allegro" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85" itemscope itemtype="https://schema.org/WebPage"><span itemprop="name">Allegro</span></a><meta itemprop="position" content="5"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="url" href="/kontakt" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85" itemscope itemtype="https://schema.org/WebPage"><span itemprop="name">Kontakt</span></a><meta itemprop="position" content="6"></li>
                    <li style="opacity: 0;" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="url" href="/test" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85" itemscope itemtype="https://schema.org/WebPage"><span itemprop="name">Test</span></a><meta itemprop="position" content="7"></li>
                </ul>
            </div>
            <div class="navbar__socials flex flex-row gap-4 z-50">
                <div class="flex-row gap-2 xl:gap-3 mr-0 xl:mr-4 items-center hidden lg:flex" role="complementary" aria-label="Media społecznościowe">
                    <a aria-label="Instagram AdsHelp" href="https://www.instagram.com/adshelp.pl" class="border-[1px] hover:border-[2px] {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'border-primary-950 bg-primary-dark hover:border-primary-dark' : 'border-stone-300 hover:border-primary-950'}  border-solid rounded-full w-[32px] h-[32px] lg:w-[40px] lg:h-[40px] xl:w-[48px] xl:h-[48px] flex items-center justify-center hover:scale-105  active:scale-95 hover:transition-all hover:cursor-pointer">
                    ...
                    <a aria-label="Facebook AdsHelp" href="https://www.facebook.com/adshelppl"  class="border-[1px] hover:border-[2px]  {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'border-primary-950 bg-primary-dark hover:border-primary-dark' : 'border-stone-300 hover:border-primary-950'} border-solid rounded-full w-[32px] h-[32px] lg:w-[40px] lg:h-[40px] xl:w-[48px] xl:h-[48px] flex items-center justify-center hover:scale-105 active:scale-95 hover:transition-all hover:cursor-pointer">
                ...
                <div class="max-[500px]:hidden" itemscope 
                itemtype="https://schema.org/CallToAction" itemprop="target">{#if id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt')}<Button label="Darmowa współpraca" theme="orange" href="/kontakt" itemprop="url" />{:else}<Button label="Darmowa współpraca" theme="dark" href="/kontakt" itemprop="url" />{/if}<meta itemprop="name" content="Rozpocznij darmową współpracę"></div>
            ...
            {#if isMenuOpen}
            <div class="flex flex-col pt-28 max-[440px]:px-8 px-14 absolute top-0 left-0 bottom-0 right-0 bg-white z-[40]" transition:fade={{ duration: 100 }} itemscope itemtype="https://schema.org/SiteNavigationElement" aria-label="Menu mobilne">
                <ul class="flex flex-col gap-5" transition:fly={{ y: 50, opacity: 0, easing: sineInOut, duration: 200 }} itemscope itemtype="https://schema.org/BreadcrumbList" role="menu">
