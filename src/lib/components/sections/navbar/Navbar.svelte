...
<nav id="navbar" class="navbar z-10">
    <div class="max-w-screen flex justify-between pr-6 xl:pr-10 2xl:pr-20 pl-6 xl:pl-10 2xl:pl-20 py-4 xl:py-6 align-middle">
        <div class="navbar__menu flex flex-row gap-6 xl:gap-10 items-center z-10">
            ...
            <div class="navbar__menu__divider text-neutral-200 hidden xl:flex">|</div>
            <ul class="flex flex-row gap-3 max-[852px]:hidden">
                <li class="text-sm text-primary-950 active:scale-[0.98] active:transition-all"><a href="/" class=" hover:bg-stone-200 transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">O mnie</a></li>
                <li class="text-sm text-primary-950 active:scale-[0.98] active:transition-all"><a href="/" class=" hover:bg-stone-200 transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Dlaczego warto</a></li>
                <li class="text-sm text-primary-950 active:scale-[0.98] active:transition-all"><a href="/" class=" hover:bg-stone-200 transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Usługi</a></li>
                <li class="text-sm text-primary-950 active:scale-[0.98] active:transition-all"><a href="/" class=" hover:bg-stone-200 transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Blog</a></li>
                <li class="text-sm text-primary-950 active:scale-[0.98] active:transition-all"><a href="/" class=" hover:bg-stone-200 transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Kontakt</a></li>
            </ul>
        </div>
        <div class="navbar__socials flex flex-row gap-4 z-10">
            ...
            <div class="max-[500px]:hidden"><Button label="Zrealizujmy kampanię" theme="dark" /></div>
            <div class="hidden max-[852px]:flex justify-center items-center rounded-full bg-primary-600 py-3 px-5 active:scale-[0.98] active:transition-all" onclick={toggle}>
        ...
        <div class="flex flex-col pt-28 max-[440px]:px-8 px-14 absolute top-0 left-0 bottom-0 right-0 bg-white z-[4]" transition:fade={{ duration: 100 }}>
            <ul class="flex flex-col gap-5" transition:fly={{ y: 50, opacity: 0, easing: sineInOut, duration: 200 }}>
                <li class="max-[310px]:text-2xl-bold text-3xl-bold font-display text-primary-950">O mnie</li>
                <li class="max-[310px]:text-2xl-bold text-3xl-bold font-display text-primary-950">Dlaczego warto</li>
                <li class="max-[310px]:text-2xl-bold text-3xl-bold font-display text-primary-950">Usługi</li>
                <li class="max-[310px]:text-2xl-bold text-3xl-bold font-display text-primary-950">FAQ</li>
                <li class="max-[310px]:text-2xl-bold text-3xl-bold font-display text-primary-950">Kontakt</li>
            </ul>
