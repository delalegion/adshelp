    ...
    <nav id="navbar" role="navigation" vocab="http://schema.org" typeof="SiteNavigationElement" itemscope itemtype="https://schema.org/SiteNavigationElement" class="navbar z-10 {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'bg-primary-950' : ''} {id.includes('article') ? 'bg-white' : ''} transition-all transition-300">
        <div class="max-w-screen flex justify-between pr-6 xl:pr-10 2xl:pr-20 pl-6 xl:pl-10 2xl:pl-20 py-4 xl:py-6 align-middle">
            <div class="navbar__menu flex flex-row gap-6 xl:gap-10 items-center z-45" id="menu">
                ...
                role="menubar">
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="item" href="/#about" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'}  transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85"><span itemprop="name"></span>O mnie</a><meta itemprop="position" content="1"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="item" href="/#steps" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85"><span itemprop="name"></span>Dlaczego warto</a><meta itemprop="position" content="2"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="item" href="/#services" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85"><span itemprop="name"></span>Usługi</a><meta itemprop="position" content="3"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="item" href="/blog" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85"><span itemprop="name"></span>Blog</a><meta itemprop="position" content="4"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="item" href="/allegro" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85"><span itemprop="name"></span>Allegro</a><meta itemprop="position" content="5"></li>
                    <li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" role="menuitem" class="text-sm {id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a itemprop="item" href="/kontakt" class="{id.includes('/blog') && !id.includes('/article') || id.includes('/kontakt') ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85"><span itemprop="name"></span>Kontakt</a><meta itemprop="position" content="6"></li>
                </ul>
            </div>
