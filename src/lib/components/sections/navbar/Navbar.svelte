...
<nav id="navbar" class="navbar z-10 {id === '/blog' ? 'bg-primary-950' : ''} transition-all transition-300">
    <div class="max-w-screen flex justify-between pr-6 xl:pr-10 2xl:pr-20 pl-6 xl:pl-10 2xl:pl-20 py-4 xl:py-6 align-middle">
        <div class="navbar__menu flex flex-row gap-6 xl:gap-10 items-center z-10">
            ...
            <div class="hidden xl:flex {id === '/blog' ? 'text-[#340B07]' : 'text-neutral-200'}">|</div>
            <ul class="flex flex-row gap-3 max-[852px]:hidden">
                <li class="text-sm {id === '/blog' ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a href="#about" class="{id === '/blog' ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'}  transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">O mnie</a></li>
                <li class="text-sm {id === '/blog' ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a href="#steps" class="{id === '/blog' ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Dlaczego warto</a></li>
                <li class="text-sm {id === '/blog' ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a href="#services" class="{id === '/blog' ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Usługi</a></li>
                <li class="text-sm {id === '/blog' ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a href="/blog" class="{id === '/blog' ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Blog</a></li>
                <li class="text-sm {id === '/blog' ? 'text-primary-100' : 'text-primary-950'} active:scale-[0.98] active:transition-all"><a href="#contact" class="{id === '/blog' ? 'hover:bg-primary-dark' : 'hover:bg-stone-200'} transition-all px-2.5 xl:px-3.5 py-2 xl:py-3 rounded-full hover:opacity-85">Kontakt</a></li>
            </ul>
        </div>
        ...
        <div class="flex flex-col pt-28 max-[440px]:px-8 px-14 absolute top-0 left-0 bottom-0 right-0 bg-white z-[4]" transition:fade={{ duration: 100 }}>
            <ul class="flex flex-col gap-5" transition:fly={{ y: 50, opacity: 0, easing: sineInOut, duration: 200 }}>
                ...
                <li class="max-[310px]:text-2xl-bold text-3xl-bold font-display text-primary-950"><a href="/blog">Blog</a></li>
