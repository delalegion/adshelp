...
<div class="flex flex-row bg-primary-950 my-24 rounded-3xl overflow-hidden">
    <div class="flex-5 relative overflow-hidden">
        <enhanced:img src={consult} alt="Ipad tablet with animation" class="absolute w-full h-full object-cover bg-bottom" />
    </div>
    <div class="flex-3 py-8 px-12">
