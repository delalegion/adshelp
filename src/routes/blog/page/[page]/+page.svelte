          ...
          "@graph": [
            ...
            "itemListElement": [
                ...
                },
                {
                    ...
                    "position": 3,
                    "name": "Page of blog",
                    "item": "https://adshelp.pl/blog/page/"+data.param
                }
            ]
            }
          ]
...
<svelte:head>
    <meta property="og:url" content="https://adshelp.pl/blog/page/{data.param}">
    <meta property="url" content="https://adshelp.pl/blog/page/{data.param}">
...
<SvelteSeo
  ...
  canonical="https://adshelp.pl/blog/page/{data.param}"
  ...
  openGraph={{
    ...
    url: "https://adshelp.pl/blog/page/"+data.param,
    type: "website",
    images: [
      {
