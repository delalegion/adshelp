<script lang="ts">
    ...
    let paginationUrl = $state(`/blog/category/${parametrs.params.category}/`);
          ...
          "@graph": [
            ...
            "itemListElement": [
                ...
                },
                {
                    "@type": "ListItem",
                    "position": 2,
                    "name": "Kategoria strona",
                    "item": "https://adshelp.pl/blog/category/"+category+"/"+data.param
                }
            ]
            }
          ]
...
<svelte:head>
    <meta property="og:url" content="https://adshelp.pl/blog/category/{category}/{data.param}">
    <meta property="url" content="https://adshelp.pl/blog/category/{category}/{data.param}">
...
<SvelteSeo
  ...
  canonical="https://adshelp.pl/blog/category/{category}/{data.param}"
  ...
  openGraph={{
    ...
    url: "https://adshelp.pl/blog/category/"+category+"/"+data.param,
    type: "website",
    images: [
      {
