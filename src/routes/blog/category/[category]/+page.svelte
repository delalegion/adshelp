...
<svelte:head>
    <meta property="og:url" content="https://adshelp.pl/blog/category/{category}">
    <meta property="url" content="https://adshelp.pl/blog/category/{category}">
...
<SvelteSeo
  ...
  canonical="https://adshelp.pl/blog/category/{category}"
  ...
  openGraph={{
    ...
    url: "https://adshelp.pl/blog/category/"+category,
    type: "website",
    images: [
      {
